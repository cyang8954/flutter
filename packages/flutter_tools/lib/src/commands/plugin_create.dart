...
class PluginCreateCommand extends FlutterCommand {
  PluginCreateCommand({ bool verboseHelp = false }) {
    ...
    argParser.addOption(
      ...
      help: 'The organization responsible for your new Flutter plugin project, in reverse domain name notation. '
